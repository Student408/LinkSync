...
<main>
    ...
    <div class="link-list">
        <?php
        // Query to fetch links created by the current user or public links
        ...
        if ($result->num_rows > 0) {
            while ($row = $result->fetch_assoc()) {
                ...
                // Check if the logged-in user is the owner of the link
                if ($row['username'] === $currentUser) {
                    // Show edit and delete buttons for the owner's link
